...
import { PlusCircle, Download, ShieldCheck, Radio } from 'lucide-react';
...
export default function AdminDashboard({ onToggleView }) {
  ...
  return (
    <div className="admin-app">
      {/* Top Navbar */}
      <AdminNavbar onToggleView={onToggleView} isMobileView={false} />
